        ...
        try {
            ...
            if (affectedRows > 0) {
                ...
                if (rs.next()) {
                    ...
                    // Insert into the Motorbike table using the new listing ID
                    String sqlInsertMotorbike = "INSERT INTO Motorbike (VIN, Price, Make, Model, Year, Mileage, listingID) VALUES (?, ?, ?, ?, ?, ?, ?)";
                    pstmt = conn.prepareStatement(sqlInsertMotorbike);
