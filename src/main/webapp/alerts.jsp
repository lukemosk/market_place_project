...
>>>>>>> 8608240465b8176c249af9e75b6de1ed7c08aeb0
    ...
    String delete_generic_alert = request.getParameter("delete_generic_alert_id");
    ...
    if(delete_generic_alert != null) {
        try {
            Connection conn = ApplicationDB.getConnection();
            String deleteGenericAlert = "DELETE FROM alerts_generic WHERE alert_id=" + delete_generic_alert + ";";
            conn.prepareStatement(deleteGenericAlert).executeUpdate();
        } catch (Exception e) {
            out.println("<h2>SQL Error when trying to delete generic alert!</h2>");
            return;
        }
        response.sendRedirect("alerts.jsp");
        return;
    ...
    try {
        ...
        String getGenericAlertsQuery = "SELECT alert_id, message FROM alerts_generic WHERE user_id=" + currentID + ";";
        rs = conn.prepareStatement(getGenericAlertsQuery).executeQuery();
        ...
        while(rs.next()) {
            ...
            <div class="important">
                <h3><%= message %></h3>
                <form action="alerts.jsp" method="POST">
                    <button type="submit" name="delete_generic_alert_id" value="<%= id %>">Delete</button>
                </form>
            </div>
            <br>
            <%
        ...
        out.println("<h2>SQL Error when trying to load generic alerts!</h2>");
        return;
    }
    %>
    <br><br><br><br>
